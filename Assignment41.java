...
public class Assignment41 {
	...
	public static void main(String[] args) {
		if (args.length != 2) {
		      System.err.println("Usage: Ass41 <input path> <output path>");
		      System.exit(-1);
		    }
			...
			try {
				...
				Job job = new Job(conf, "Invalid Records Filter");
				job.setJarByClass(Assignment41.class);
				...
				job.setMapperClass(Ass41Mapper.class);
				job.setReducerClass(Ass41Reducer.class);
				
				//Set the combiner
				job.setCombinerClass(Ass41Reducer.class);
